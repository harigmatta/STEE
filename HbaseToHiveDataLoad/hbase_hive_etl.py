...
import json
import sys
from util.spark_session import spark_session
...
def main():
    try:
        ...
        schema = table_config[table_name]['Catalog']
        ...
        final_df = query_hbase_table(spark, schema, table_name, load_type, query, filter_col, business_date)
        final_df.show()
